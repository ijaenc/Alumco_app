      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-md mx-auto px-4 py-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <Button size="sm" variant="outline" onClick={() => toast.info("Exportar disponible próximamente")}>
              ...
              <>
                <Card className="p-4">
                  ...
                  <div className="space-y-4">
                    {[
                      { label: "Tasa de aprobación", value: stats.passRate, color: "bg-green-500" },
                      { label: "Promedio de puntajes", value: stats.averageScore, color: "bg-blue-500" },
                    ].map((item) => (
                      <div key={item.label}>
