...
import { getUsersSummary, type UserSummary } from "../services/userManagementService";
...
export default function AdminMessages() {
  ...
  const allUsers = getUsersSummary();
  ...
  const handleSendMassMessage = () => {
    if (!massMessageContent.trim() || selectedUsers.length === 0) {
      toast.error("Completa todos los campos", {
        description: "Selecciona usuarios y escribe un mensaje",
      });
      return;
    }

    toast.success(`Mensaje enviado a ${selectedUsers.length} usuario(s)`, {
      description: "El mensaje ha sido entregado exitosamente",
    });
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex-1">
              <h1 className="text-xl font-semibold text-gray-900">
                Mensajería - Administrador
              </h1>
              <p className="text-xs text-gray-500">
                Gestiona conversaciones y envía mensajes masivos
              </p>
            </div>
          </div>
              ...
              <div className="flex flex-col items-center justify-center py-16 px-4">
                ...
                <p className="text-sm text-gray-600 text-center">
                  {searchQuery
                    ...
                    : "Las conversaciones con usuarios aparecerán aquí"}
                </p>
              </div>
            )}
          </div>
          ...
          <div className="space-y-4">
            ...
            <Card className="p-4">
              ...
              <p className="text-xs text-gray-500 mb-4">
                {massMessageContent.length} caracteres
              </p>

              <Button
                onClick={handleSendMassMessage}
                disabled={!massMessageContent.trim() || selectedUsers.length === 0}
